...
namespace ETravUpdater
{
    public partial class Form1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        String ConnStr2 = "Data Source=etrav-china;Initial Catalog=Images;Persist Security Info=True;User ID=Application;Password=noitacilppa";
        public Assembly a;
        public string id;
        string version;
       ...
       private void gridControl1_Click(object sender, EventArgs e)
        ...
        public void databaseFileReadold(string varappName, string varPathToNewLocation) //puts a file from tblapplications database to tblVSapplications database.
        {
            ...
            using (SqlCommand command = SqlConn.CreateCommand())
            {
                ...
                command.CommandText = "SELECT Application FROM tblapplications WHERE Applicationname=" + "'" + varappName + "'";
                using (SqlDataReader sqlQueryResult = command.ExecuteReader(CommandBehavior.SequentialAccess))
                    ...
                    while (sqlQueryResult.Read())
                    {
                        ...
                        //File.Copy(outbyte.ToString(), userRoot + varappName, true);
